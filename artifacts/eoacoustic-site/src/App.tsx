...
function Hero() {
  return (
    <section className="hero">
      ...
      <div className="hero-visual reveal-delay" style={{ backgroundImage: `url(${media.materialCloseup})` }} aria-label="A textured EOACOUSTIC panel">
